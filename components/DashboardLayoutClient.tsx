...
const PAGE_TITLES: Record<string, string> = {
  '/dashboard': 'Program Coordinator',
  '/dashboard/profile': 'Organization Profile',
  '/dashboard/engagement': 'Inbox',
  '/dashboard/calendar': 'Bookings',
  '/dashboard/contacts': 'Profile',
  '/dashboard/bookings': 'Bookings',
  '/dashboard/history': 'My Bookings',
  '/dashboard/my-bookings': 'My Bookings',
  '/dashboard/requests': 'My Bookings',
  '/dashboard/requests/new': 'New Booking Request',
  '/dashboard/settings': 'Settings',
  '/dashboard/forms': 'Profile Forms',
...
export function DashboardLayoutClient({ children, role, title = "Arts & Aging", notifications, unreadCount, userSession, homeName, bookingsAccessAllowedRoles = [] }: DashboardLayoutProps) {
  ...
  const portalConfig = {
    ...
    HOME_ADMIN: { label: 'Program Coordinator', bg: 'bg-accent-400', text: 'text-primary-900' },
